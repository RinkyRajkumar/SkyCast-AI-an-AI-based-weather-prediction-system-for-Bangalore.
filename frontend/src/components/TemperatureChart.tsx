  ...
  return (
    <article className="panel chart-panel">
      <div className="section-heading">
        ...
        <span className="unit-label">&deg;C</span>
      </div>
      <div className="chart-container" aria-label="Temperature prediction line chart">
        <ResponsiveContainer width="100%" height="100%">
          <LineChart data={data} margin={{ top: 12, right: 12, left: 0, bottom: 0 }}>
            ...
            <Tooltip contentStyle={tooltipStyle} formatter={(value) => [wholeDegrees(value), 'Temperature']} />
            <Line type="monotone" dataKey="temperature" stroke="url(#temperature-by-height)" strokeWidth={3} dot={{ r: 5, fill: '#176b5b', stroke: '#f7faf8', strokeWidth: 3 }} activeDot={{ r: 7 }} />
          </LineChart>
        </ResponsiveContainer>
      </div>
    </article>
